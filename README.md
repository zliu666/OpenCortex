...
> Modular AI Agent Framework — Built on OpenCortex, hardened with AgentSys security, enhanced with Hermes capabilities.

## Overview

OpenCortex is a production-grade AI Agent framework that combines the best of three open-source projects:

- **[OpenCortex](https://github.com/hkudslab/open-harness)** — Clean, modular agent skeleton (core engine, 43+ tools, permission system)
...
- [x] Phase 1: Fork OpenCortex core, Zellij terminal integration
